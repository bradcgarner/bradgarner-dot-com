...
import { 
  ...
  pageMainContainer}   from '../../helpers/common-styles';
import H1                 from '../_general/h1';
  ...
  return <div className='page-content-container'>
    <H1 text={m.h1Tag} />
      <div className='content-inner'>
        ...
        <p>Effective date: August 1, 2020, updated {lastUpdate}</p>

        <p>{theCompany} ("us", "we", "our", "this site") operates the {thisDomain} website (hereinafter referred to as the "Service").</p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>Submitted Data is data specifically submitted to us via the <a href='https://www.urbanmeadow.org/contact'>Contact</a> page.</p>
          </li>
          <li>
        ...
        <p>Submitted Data is data specifically submitted to us via the <a href='https://www.urbanmeadow.org/contact'>Contact</a> page.  When submitting data, you must choose which type of data you are submitting.  Types include "general inquiry", "submit project", "submit resource", "request consultation", and "submit article".  Our usage of each type of data is listed below.</p>

        <ul>
          <li>
            <p><strong>Submitted Data Type: General Inquiry</strong></p>
            <p>We will treat General Inquiry data as Personal Data (i.e. stored within our systems and not made publicly accessible or shared with third parties).</p>
          </li>

          <li>
            <p><strong>Submitted Data Type: Submit Project</strong></p>
            <p>Project data is generally intended to be data about a specific project, installation, or location. This data is submitted by a user to us.</p>
            <p>Upon submission of project data to us, you grant us nonexclusive rights to publish the project data on {theCompany} and on social media as maintained by {theCompany}.</p>
            <p>We require certain personal data to accept project submissions, such as the name and email address of the person submitting, and name and location of the project.  We may attempt to verify this information.  When submitting you may check boxes to anonymize certain portions of information, such as the name of the party submitting, or the specific address of the project; checking these boxes allows us to maintain project information on file, but revokes our rights to publish that information.</p>
            <p>We reserve the right to reject any submission for any reason or for no reason.</p>
          </li>

          <li>
            <p><strong>Submitted Data Type: Submit Resource</strong></p>
            <p>Resource data is generally intended to be a link (a url) to an online resource, e.g. a website, a blog, a pdf, an online store, or any other online location. This data is submitted by a user to us.</p>
            <p>See also "Resource Republishing" below.</p>
            <p>We require certain personal data to accept resource submissions, such as the name and email address of the person submitting.  We may attempt to verify this information.  When submitting you may check boxes to anonymize certain portions of information, such as the name of the party submitting; checking these boxes allows us to maintain project information on file, but revokes our rights to publish that information.</p>
            <p>We reserve the right to reject any submission for any reason or for no reason.</p>
          </li>

          <li>
            <p><strong>Resource Republishing</strong></p>
            <p>On the <a href='https://www.urbanmeadow.org/contact'>Resources</a> page of {theCompany}, we publish the following information for various resources owned and not owned by {theCompany}: the specific url, the website featured image, the name of the website, the page title, the website favicon, the page description, and possibly other metadata obtained from the website.  I.e. this is the same information that is republished when urls are shared via emails, social media, and search engines.</p>
            <p>In the event that any website owner requests that we remove from {theCompany} information to which they hold the copyright, we will make every attempt to comply expeditiously.  Our intent is to share information, including directing traffic to sites owned and maintained by others; this intent should be clearly demonstrated by prominently displaying the source of such metadata (i.e. the url of the site of origin).</p>
          </li>

          <li>
            <p><strong>Submitted Data Type: Request Consultation</strong></p>
            <p>You may use {theCompany} to request that a listed consultant on {theCompany} provide you with consultation or advice.</p>
            <p>Upon submission of a request for consultation, you grant us rights to distribute information contained within that request to any consultant listed on {theCompany}, including employeed of that consultant.</p>
            <p>We will treat Consultation Request data as Personal Data (i.e. stored within our systems and not made publicly accessible or shared with third parties, except as noted above).</p>
            <p>{theCompany} does not provide consulting services or any other services other than hosting and maintaining {theCompany}.  {theCompany}'s sole involvement in consulting services is providing a mechanism for prospective customers to find potential consultants.  {theCompany} records the information submitted and forwards it to one or more consultants, and provides no services beyond those specificially enurmerated herein.</p>
            <p>{theCompany} does not guarantee that any consultant will accept any particular request for work.  Consultants listed on {theCompany} are not employed by {theCompany}, and it shall be assumed that consultants reserve the right to reject any request for any reason or for no reason.</p>
            <p>In the event that you work with a consultant as a result of a request made via {theCompany}, your associated legal and financial obligations are solely with the selected consultant; {theCompany} will not have any involvement with any consulting contract.</p>
          </li>

          <li>
            <p><strong>Submitted Data Type: Submit Article</strong></p>
            <p>You may submit an article for publication on {theCompany}.</p>
            <p>Upon submission of an article to us, you grant us nonexclusive rights to publish the article on {theCompany} and to publicize the article via social media or other means.</p>
            <p>We require certain personal data to accept article submissions, such as the name and email address of the person submitting; we will treat this data as Personal Data (i.e. stored within our systems and not made publicly accessible or shared with third parties). Upon publication, the name of the article's author(s) will be published.</p>
            <p>We reserve the right to edit articles received.  We reserve the right to reject any submission for any reason or for no reason.</p>
          </li>
        ...
        <p>Upon any changes, we will update the "effective date" at the top of this Privacy Policy.</p>
        <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>

        <h2>Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, please contact us:</p>
        <ul>
          <li>By visiting this page on our website: <Link href='/contact'><a>{`${thisUrl}/contact`}</a></Link></li>    
        </ul>
      </div>    
    <style jsx>{`
