export default function TooltipCss() {
  return <div>
    <style jsx global>{`
      ...
      .tooltip.tooltip-small .popover {
        width: 124px;
        margin-left: -62px;
        margin-top: 3px;
      }
      .tooltip.tooltip-small .popover p {
        text-align: center;
      }
      ...
      .tooltip.tooltip-bottom.tooltip-bottom-left .popover {
        top: auto;
        bottom: 115%;
        margin-bottom: 3px;
        margin-top: 0;
      ...
      .tooltip.tooltip-bottom.tooltip-bottom-left .popover:after, 
      .tooltip.tooltip-bottom.tooltip-bottom-left .popover:before,
