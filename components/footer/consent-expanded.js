...
export default class ConsentExpanded extends React.Component {
    ...
    this.state = {
      ...
      selections: [
        ...
        },
        {
          ...
          text:     'By checking this option, you allow your browser to remember which content you have already viewed on this site, so that the site can make better recommendations for you.  If you uncheck this box, your experience may be more static.'
        },
        {
          key:     'userStats',
  ...
  render() {
    ...
    const header = <div className='intro'>
      ...
      <button className={`link-button privacy ${privacyGoTo} ${pathClass}-banner ${this.props.consent.consented?true:false}-${this.props.consent.userHistory}-${this.props.consent.userStats}`} >
        <Link prefetch={false} href={`/privacy`}>
          <a className='link' 
            role='link'>{privacy.policyExpandedLabel}</a> 
        </Link>
      </button>
      <style jsx>{`
        .intro {
    ...
    const footer = <div className='button-container'>
      <button
        className={`ok-button privacy ${privacySave} ${pathClass}-banner ${this.props.consent}-${this.props.userHistory}-${this.props.userStats}---${this.props.consent.consented?true:false}-${this.props.consent.userHistory}-${this.props.consent.userStats}`}        
        type='submit'
